...
app.get('/', (req, res) => {
  res.json({ status: "ZimConnect v3.4 Running", storage: "ImageKit.io", avatar: "Zimbabwe Bird - My Yut" });
});
...
app.listen(PORT, () => console.log(`ZimConnect v3.4 FINAL running on ${PORT} - ImageKit + QR + My Yut Online`));
