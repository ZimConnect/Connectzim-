...
app.get('/', (req, res) => {
  res.json({ status: "ZimConnect v3.2 Running", storage: "ImageKit.io", avatar: "Zimbabwe Bird - My Yut", features: ["TV","Radio","Podcast","Music","Video Club","Book Store","Marketplace","Jobs","Accommodation","Resorts","Car Sales","Misc","Bulletin","Assistant"] });
});
...
app.listen(PORT, () => console.log(`ZimConnect v3.2 FINAL running on ${PORT} - ImageKit + My Yut + DJ Tewe Online`));
